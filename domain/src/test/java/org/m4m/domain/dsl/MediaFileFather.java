...
public class MediaFileFather {
    private MediaSourceFather mediaSourceFather;

    public MediaFileFather(Father create) {
        mediaSourceFather = create.mediaSource();
    }

    public MediaFileFather push(Frame frame) {
        mediaSourceFather.with(frame);
        return this;
    }

    public MediaFile construct() {
        return new MediaFile(mediaSourceFather.construct());
    }
}
