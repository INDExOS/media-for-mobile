...
public class EofCommandHandlerSpy extends EofCommandHandler {
    private final CommandProcessorSpy commandProcessorSpy;

    public EofCommandHandlerSpy(IOutput output, Plugin plugin, IFrameAllocator frameAllocator, CommandProcessorSpy commandProcessorSpy) {
