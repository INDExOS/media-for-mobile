...
public class PullDataCommandHandlerSpy extends PullDataCommandHandler {
    private final CommandProcessorSpy commandProcessorSpy;

    public PullDataCommandHandlerSpy(IPluginOutput output, Render input, CommandProcessorSpy commandProcessorSpy) {
        super(output, input);
