...
public class PushDataCommandHandlerSpy extends PushDataCommandHandler {
    private final CommandProcessorSpy commandProcessorSpy;

    public PushDataCommandHandlerSpy(IOutput output, Plugin plugin, IFrameAllocator frameAllocator, CommandProcessorSpy commandProcessorSpy) {
