...
public class PushSurfaceCommandHandlerSpy extends PushSurfaceCommandHandler {
    private final CommandProcessorSpy commandProcessorSpy;

    public PushSurfaceCommandHandlerSpy(VideoDecoder decoder, Encoder encoder, CommandProcessorSpy commandProcessorSpy) {
